      ...
      <div>
        <div className="min-h-screen flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-red-600 text-black rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
          >
            Logout
          </button>
        </div>
                ...
                {Object.keys(visibleSeries).map((series) => (
                  ...
                  >
                    <input
                      type="checkbox"
                      checked={
                        visibleSeries[series as keyof typeof visibleSeries]
                      }
                      onChange={() =>
                        toggleSeries(series as keyof typeof visibleSeries)
                      }
